...
fig.suptitle("Total Variation Error vs Communication Rounds at Different Time Steps", fontsize=18)
...
plt.ylabel("Average Cumulative Variation")
plt.title("Average Cumulative Total Variation Error vs Communication Rounds")
plt.grid(True)
plt.legend()
plt.tight_layout()
